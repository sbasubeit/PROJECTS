...
export const projectsData: Project[] = [
  ...
  { id: 6, sector: "القدرات البشرية", name: "صندوق الشهادات المهنية في الجامعات", agency: "جامعة الحدود الشمالية + جامعة الملك عبدالعزيز", signed: false },
  { id: 7, sector: "القدرات البشرية", name: "وحدة الموارد البشرية المشتركة في الجمعيات الشبابية", agency: "المجلس التخصصي للجمعيات الشبابية", signed: false },
  { id: 8, sector: "القدرات البشرية", name: "تأهيل أخصائي أندية الفتيات", agency: "اللجنة التنسيقية للجمعيات النسائية - مركز مساق", signed: false },
  { id: 9, sector: "القدرات البشرية", name: "كلية إدارة القطاع غير الربحي", agency: "مؤسسة الريادة الاجتماعية", signed: false },
  ...
  { id: 19, sector: "السجناء وأسرهم", name: "العيادات الإرشادية داخل السجون", agency: "جمعية المودة للتنمية الأسرية - لجنة تراحم", signed: false },
